# -*- coding: utf-8 -*-
"""NACC_HABS-HD_Prompts

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1t6H4CrTiRjc7L7uts33ZVFci4qHWvPbO
...
for idx, row in df.iterrows():
  ...
  if paragraph1:
    output_lines.append(paragraph1)

with open('form1_output.txt', 'w') as f:
  for paragraph1 in output_lines:
    f.write(paragraph1 + '\n\n')

!cp /content/form1_output.txt "/content/drive/MyDrive/nacc habs-hd mapping/form1_output.txt"
...
for idx, row in df.iterrows():
  ...
  if paragrapha1:
    output_lines.append(paragrapha1)

with open('forma1_output.txt', 'w') as f:
  for paragrapha1 in output_lines:
    f.write(paragrapha1 + '\n\n')

!cp /content/forma1_output.txt "/content/drive/MyDrive/nacc habs-hd mapping/forma1_output.txt"
...
for idx, row in df.iterrows():
  ...
  output_lines.append(paragrapha2)

with open('forma2_output.txt', 'w') as f:
  for paragrapha2 in output_lines:
    f.write(paragrapha2 + '\n\n')

!cp /content/forma2_output.txt "/content/drive/MyDrive/nacc habs-hd mapping/forma2_output.txt"
...
for idx, row in df.iterrows():
  ...
  if paragrapha3:
    output_lines.append(paragrapha3)

with open('forma3_output.txt', 'w') as f:
  for paragrapha3 in output_lines:
    f.write(paragrapha3 + '\n\n')

!cp /content/forma3_output.txt "/content/drive/MyDrive/nacc habs-hd mapping/forma3_output.txt"
...
for idx, row in df.iterrows():
  ...
  if paragrapha4:
    output_lines.append(paragrapha4)

with open('forma4_output.txt', 'w') as f:
  for paragrapha4 in output_lines:
    f.write(paragrapha4 + '\n\n')

!cp /content/forma4_output.txt "/content/drive/MyDrive/nacc habs-hd mapping/forma4_output.txt"
...
for idx, row in df.iterrows():
  ...
  if paragrapha5:
    output_lines.append(paragrapha5)

with open('forma5_output.txt', 'w') as f:
  for paragrapha5 in output_lines:
    f.write(paragrapha5 + '\n\n')

!cp /content/forma5_output.txt "/content/drive/MyDrive/nacc habs-hd mapping/forma5_output.txt"
...
for idx, row in df.iterrows():
    ...
    if paragraphb1:
      output_lines.append(paragraphb1)

with open('formb1_output.txt', 'w') as f:
  for paragraphb1 in output_lines:
    f.write(paragraphb1 + '\n\n')

!cp /content/formb1_output.txt "/content/drive/MyDrive/nacc habs-hd mapping/formb1_output.txt"

## Form B2: HIS and CVD - take another look at this
...
for idx, row in df.iterrows():
    ...
    if paragraphb2:
      output_lines.append(paragraphb2)

with open('formb2_output.txt', 'w') as f:
  for paragraphb2 in output_lines:
    f.write(paragraphb2 + '\n\n')

!cp /content/formb2_output.txt "/content/drive/MyDrive/nacc habs-hd mapping/formb2_output.txt"
...
mapping_arising = {
    1: "slow and needs more than one attempt",
    2: "pushing themselves up from the arms of the seat",
    3: "falling back and trying more than once, but getting up without help",
    4: "unable to get up without help"
}

mapping_gait = {
    1: "walks slowly and may shuffle with short steps, but has no festination or propulsion",
    2: "walks with difficulty, but does not require assistance and has some festination and propulsion",
    3: "has a severe disturbance of gait and requires assistance",
...
for idx, row in df.iterrows():
    ...
    if isinstance(arisingx_source, str) and str(arisingx_source) not in ['-8888', '-9999']:
        custom_map = {
            ...
            'Not attempted, you felt unsafe': "did not attempt to rise from the chair because the examiner felt unsafe",
            'Not attemmpted, participant felt unsafe': "did not attempt to rise from the chair because they felt unsafe",
            'Participant unable to understand instructions': "did not attempt to rise from the chair because they did not understand the instructions"
        }
    ...
    if isinstance(gaitx_source, str) and str(gaitx_source) not in ['-8888', '-9999']:
        custom_map_gait = {
            ...
            'Not attempted, you felt unsafe': "did not attempt to walk because the examiner felt unsafe",
            'Not attemmpted, participant felt unsafe': "did not attempt to walk because they felt unsafe",
            'Participant unable to understand instructions': "did not attempt to walk because they did not understand the instructions"
        }
    ...
    if paragraphb3:
      output_lines.append(paragraphb3)

with open('formb3_output.txt', 'w') as f:
  for paragraphb3 in output_lines:
    f.write(paragraphb3 + '\n\n')

!cp /content/formb3_output.txt "/content/drive/MyDrive/nacc habs-hd mapping/formb3_output.txt"
...
for idx, row in df.iterrows():
  ...
  if paragraphb6:
    output_lines.append(paragraphb6)

with open('formb6_output.txt', 'w') as f:
  for paragraphb6 in output_lines:
    f.write(paragraphb6 + '\n\n')

!cp /content/formb6_output.txt "/content/drive/MyDrive/nacc habs-hd mapping/formb6_output.txt"
...
for idx, row in df.iterrows():
  ...
  if paragraphb8:
    output_lines.append(paragraphb8)

with open('formb8_output.txt', 'w') as f:
  for paragraphb8 in output_lines:
    f.write(paragraphb8 + '\n\n')

!cp /content/formb8_output.txt "/content/drive/MyDrive/nacc habs-hd mapping/formb8_output.txt"
...
for idx, row in df.iterrows():
  ...
  if paragraphb9:
    output_lines.append(paragraphb9)

with open('formb9_output.txt', 'w') as f:
  for paragraphb9 in output_lines:
    f.write(paragraphb9 + '\n\n')

!cp /content/formb9_output.txt "/content/drive/MyDrive/nacc habs-hd mapping/formb9_output.txt"

## Form D1: Clinicial Diagnosis
...
for idx, row in df.iterrows():
  ...
  if paragraphd1:
    output_lines.append(paragraphd1)

with open('formd1_output.txt', 'w') as f:
  for paragraphd1 in output_lines:
    f.write(paragraphd1 + '\n\n')

!cp /content/formd1_output.txt "/content/drive/MyDrive/nacc habs-hd mapping/formd1_output.txt"
...
for idx, row in df.iterrows():
  ...
  if paragraphd2:
    output_lines.append(paragraphd2)

with open('formd2_output.txt', 'w') as f:
  for paragraphd2 in output_lines:
    f.write(paragraphd2 + '\n\n')

!cp /content/formd2_output.txt "/content/drive/MyDrive/nacc habs-hd mapping/formd2_output.txt"